...
bonusDisarmChance = 80; //increase that the "betterDisarmers" get
...
largeChance = 38; //Chance that a large IED will be chosen.
...
iedInitialArray = [
		["AllCities", ["West","Guer","East","Civ"]], ["AllVillages", ["West","Guer","East","Civ"]], ["AllLocals", ["West","Guer","East","Civ"]]
	];
	
//Place the mapLocations, predefinedLocations, and markerNames of places you don't want any IEDs spawning
iedSafeZones = ["safezone1", "safezone2"];