...
T8L_var_fileSize = 45687;  								// Filesize ... smaller files will take shorter time to download!
...
T8L_var_TLine03 = "Initiating Download";				// download started
T8L_var_TLine04 = "Success";			// download finished
